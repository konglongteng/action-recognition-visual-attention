...
class DataHandler(object):
    ...
    def GetBatch(self, data_pb, verbose=False):
        ...
        if data_pb.dataset == 'ucf11':
            self.batch_data_ = self.batch_data_.reshape(
                [self.batch_data_.shape[0], self.batch_data_.shape[1], 49, 1024]).astype('float32')
...
class TrainProto(object):
    def __init__(self, bs, maxlen, stride, dataset, fps=30):
        ...
        if dataset == 'ucf11':
            ...
            self.data_file = '/home/kong/dataset/HMDB51_hdf5/traindata/valid_features.h5'
            self.num_frames_file = '/home/kong/dataset/HMDB51_hdf5/traindata/train_framenum.txt'
            self.labels_file = '/home/kong/dataset/HMDB51_hdf5/traindata/train_labels.txt'
            self.vid_name_file = '/home/kong/dataset/HMDB51_hdf5/traindata/train_filename.txt'
            self.dataset_name = 'features'
...
class TestValidProto(object):
    def __init__(self, bs, maxlen, stride, dataset, fps=30):
        ...
        if dataset == 'ucf11':
            ...
            self.data_file = '/home/kong/dataset/HMDB51_hdf5/testset/valid_features.h5'
            self.num_frames_file = '/home/kong/dataset/HMDB51_hdf5/testset/valid_framenum.txt'
            self.labels_file = '/home/kong/dataset/HMDB51_hdf5/testset/valid_labels.txt'
            self.vid_name_file = '/home/kong/dataset/HMDB51_hdf5/testset/valid_filename.txt'
            self.dataset_name = 'features'
...
def main():
  fps = 30
  data_pb = TrainProto(5,30,1,'hmdb51gln',fps)
